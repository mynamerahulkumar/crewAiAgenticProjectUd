...
from src.ragAgent.tools.rag_custom_tool import DocumentSearchTool
...
def create_agents_and_tasks(pdf_tool):
    ...
    web_search_tool = SerperDevTool()  # Define it outside the try block
...
# ===========================
st.markdown("""
    # SRP Agentic RAG powered by <img src="data:image/png;base64,{}" width="120" style="vertical-align: -3px;">
""".format(base64.b64encode(open("assets/llama.png", "rb").read()).decode()), unsafe_allow_html=True)
