...
from lead_score_flow.custom_types import Candidate, CandidateScore, ScoredCandidate
import csv
...
def combine_candidates_with_scores(
    ...
    with open("lead_scores_new.csv", "w", newline="") as f:
        writer = csv.writer(f)
    ...
    print("Lead scores saved to lead_scores_new.csv")
