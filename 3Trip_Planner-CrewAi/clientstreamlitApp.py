...
from tripPlannerAgent import TripAgents, StreamToExpander
from tripPlanTask import TripTasks
...
if __name__ == "__main__":
    ...
    with st.sidebar:
        ...
        st.sidebar.markdown(
        """
        Credits to [**@Rahul**](https://x.com/rahulrajsrpai)
        for creating **crewAI** 🚀
        """,
            unsafe_allow_html=True
        )
        ...
        st.sidebar.markdown(
            """
        <a href="https://github.com/mynamerahulkumar/crewAiAgenticProjectUd" target="_blank">
            <img src="https://media2.dev.to/dynamic/image/width=1000,height=420,fit=cover,gravity=auto,format=auto/https%3A%2F%2Fdev-to-uploads.s3.amazonaws.com%2Fuploads%2Farticles%2Fpwf3cr926c5s8ksswe66.jpeg" alt="CrewAI Logo" style="width:100px;"/>
        </a>
        """,
            unsafe_allow_html=True
        )
...
if submitted:
    ...
    st.text_area("Trip Plan Output", value=result if result else "No result.", height=600)